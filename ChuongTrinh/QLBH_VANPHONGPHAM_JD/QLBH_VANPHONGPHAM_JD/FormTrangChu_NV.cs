...
{
    public partial class FormTrangChu_NV : Form
    {
        //khái báo biến về form hiện tại là form trang chủ
        private Form currentFrch;
        KetNoi data = new KetNoi();
        FormDangNhap form = new FormDangNhap();
        public FormTrangChu_NV(FormDangNhap formdn)
        {
            InitializeComponent();
            this.form = formdn;
        }
        ...
        private void FormTrangChu_NV_Load(object sender, EventArgs e)
        {
        ...
        private void FormTrangChu_NV_FormClosing(object sender, FormClosingEventArgs e)
        {
            this.form.Dispose();
        }
